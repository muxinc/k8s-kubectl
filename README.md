...
* `v1.6.6`, `latest`     [(v1.6.6/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.6.6/Dockerfile)
* `v1.7.0-beta.2`,     [(v1.7.0-beta.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.7.0-beta.2/Dockerfile)
